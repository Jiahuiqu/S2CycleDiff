...
class SelfAtt(nn.Module):
    def __init__(self, channel_dim, num_heads, norm_groups=32, att_num=0.1):
...
if __name__ == "__main__":
    ...
    test_dataloader = DataLoader(test_data, batch_size=test_num, shuffle=False, num_workers=4, pin_memory=True)
    ...
    sr3 = SR3(device, img_size=img_size, LR_size=LR_size, loss_type='l1',
              ...
              save_path='./model/cave_x0_fuse/',
              load_path='./model/cave_x0_fuse/SR3_model_epoch-799.pt', load=True,
              inner_channel=64,
